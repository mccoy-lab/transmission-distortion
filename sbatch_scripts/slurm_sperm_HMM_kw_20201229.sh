...
#SBATCH -o "/home-3/kweave23@jhu.edu/work-rmccoy22/kweave23/sc_transmission_distortion/run_20201229/slurm_files/"

module load R/4.0.2
module load gcc/5.5.0

echo JobID_${SLURM_JOB_ID}_Sample_${SAMPLE_DIR}_chr${SLURM_ARRAY_TASK_ID} > ~/work-rmccoy22/kweave23/sc_transmission_distortion/run_20201228/${SAMPLE_DIR}/out_recomb_kw_20201229_${SAMPLE_DIR}_${SLURM_ARRAY_TASK_ID}.out
