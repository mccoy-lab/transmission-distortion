...
Rscript assign_sperm_haplotypes_rm_kw.R ~/work-rmccoy22/rmccoy22/mccarroll-sperm-seq-data/${SAMPLE_DIR}/data/${SAMPLE_DIR}_goodcellsreplicatebcs_filteredhetsnps_${SLURM_ARRAY_TASK_ID}.cellsbyrow.txt ${SAMPLE_DIR} chr${SLURM_ARRAY_TASK_ID} ~/work-rmccoy22/kweave23/sc_transmission_distortion/run_20201228/${SAMPLE_DIR}/csv_out/ 0.005 8 2500 &>> ~/work-rmccoy22/kweave23/sc_transmission_distortion/run_20201228/out_pval_y_rs_kw_20201228_${SAMPLE_DIR}_${SLURM_ARRAY_TASK_ID}.out
