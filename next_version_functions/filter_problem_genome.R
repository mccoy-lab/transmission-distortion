# This function doesn't currently work but will be added to rhapsodi next version
...
filter_problem_genome <- function(input_data_positions, chrom, exclude_genomic_positions, include_genomic_positions) {
  ...
  if(!missing(exclude_genomic_positions)) {
    ...
    data.table::setkey(exclude_genomic_positions, exclude_genomic_positions$start, exclude_genomic_positions$end)
  ...
  if(!missing(include_genomic_positions)) {
    ...
    data.table::setkey(include_genomic_positions, include_genomic_positions$start, include_genomic_positions$end)
